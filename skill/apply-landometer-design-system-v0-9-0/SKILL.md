...
## Apply the approved v0.9.0-r3 authoring authority

v0.9.0-r3 inherits the complete v0.8.9-r1 rule set. No v0.8.9 rule is removed; the only rename is `[SEARCH-01]` → `[INTERNAL-SEARCH-01]` (§7.6), with the old ID a deprecated alias for one release. Use the owning rules in the integrated master, especially:

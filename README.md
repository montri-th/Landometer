...
6. **Open the Implementation Library** — expand Foundations, Interface components, Data visualization & maps, Experience patterns, Product adaptations, or Resources only when the work needs more detail.

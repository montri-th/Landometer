...
- one explicit external Google Search GET exists only inside `CONTEXT-FIXTURE-0.1`; it sends the visible user-confirmed query in a new tab and does not persist or promote the result into evidence
